<template>
  <div class="system-boxSystemCamera-dialog-container">
    ...
    >
      <el-form
        ref="boxSystemCameraDialogFormRef"
        ...
        <el-row :gutter="35">
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
            <el-form-item label="摄像头序号" prop="cameraId">
              <el-input
                v-model="state.ruleForm.cameraId"
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
            <el-form-item label="摄像头名称" prop="cameraName">
              <el-input
                v-model="state.ruleForm.cameraName"
...
import { useBoxSystemCameraApi } from "@/api/fireCamera";
...
const onSubmit = () => {
  // 验证表单
  Promise.all([currentValidate(boxSystemCameraDialogFormRef)]).then((res) => {
